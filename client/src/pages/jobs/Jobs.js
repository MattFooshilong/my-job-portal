                ...
                <Col className='pe-0'>
                    <div className={styles.list__white}>
                        {[
                            ...
                            return (
                                <Row className='d-flex justify-content-between mt-3 border-bottom' key={i}>
                                    <Col xs={3}>
                                        <Image src='company1.jpg' alt='default-avatar' style={{ objectFit: 'cover', width: '70px', height: '70px' }} />
                                    </Col>
                                    <Col>
                                        <p className='mb-0'>{ele.name}</p>
                                        <small className='d-block text-secondary'>{ele.jobTitle}</small>
                                        <Button variant="outline-secondary" className='mt-1 mb-3'>
                                            <FontAwesomeIcon icon={faPlus} size='xs' className='me-2' />Add</Button>
                                    </Col>
                                </Row>
                            )
                        })}
